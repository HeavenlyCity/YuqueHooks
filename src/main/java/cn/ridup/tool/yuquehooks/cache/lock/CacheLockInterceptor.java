...
import cn.ridup.tool.yuquehooks.exception.FrequentAccessException;
import cn.ridup.tool.yuquehooks.exception.ServiceException;
import cn.ridup.tool.yuquehooks.utils.ServletUtils;
...
public class CacheLockInterceptor {
    ...
    @Around("@annotation(cn.ridup.tool.yuquehooks.cache.lock.CacheLock)")
