...
public class LevelCacheStore extends AbstractStringCacheStore {
    ...
    public LevelCacheStore(YuqueProperties yuqueProperties) {
        super.yuqueProperties = yuqueProperties;
    }
    ...
    public void init() {
        ...
        try {
            //work path
            File folder = new File(yuqueProperties.getWorkDir() + ".leveldb");
